...
class SignatureTest < Test::Unit::TestCase
    def test_parse_signature
        ...
        assert_equal TArray.new(TString.instance), sig.type
    ...
    def test_parse_method_signature
        ...
        assert_equal TInt.instance, sigs[0].type
        assert_equal 'leastBorders', sigs[0].name
        assert_equal TArray.new(TString.instance), sigs[1].type
        assert_equal 'X', sigs[1].name
        assert_equal TArray.new(TInt.instance), sigs[2].type
        assert_equal 'Y', sigs[2].name
        assert_equal TArray.new(TDouble.instance), sigs[3].type
        assert_equal 'R', sigs[3].name
        assert_equal TChar.instance, sigs[4].type
        assert_equal 'my_x1', sigs[4].name
        assert_equal TLong.instance, sigs[5].type
        assert_equal 'y1', sigs[5].name
        assert_equal TFloat.instance, sigs[6].type
        assert_equal 'x2', sigs[6].name
        assert_equal TArray.new(TArray.new(TInt.instance)), sigs[7].type
