...
class SignatureTest < Test::Unit::TestCase
    def test_parse_signature
        ...
        assert_raise InvalidVariableName do parse_signature 'int not&ok&name' end
        assert_raise InvalidVariableName do parse_signature 'int 0zero' end
        sig = parse_signature 'String[] a_valid_nam3'
        assert_equal Types::Array.new(Types::String.instance), sig.type
    ...
    def test_parse_method_signature
        ...
        assert_equal Types::Long.instance, sigs[5].type
